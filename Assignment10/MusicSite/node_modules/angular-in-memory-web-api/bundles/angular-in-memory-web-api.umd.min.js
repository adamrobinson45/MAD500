 ...
 * License: MIT
 */
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("rxjs"),require("rxjs/operators"),require("@angular/core"),require("@angular/common"),require("@angular/common/http")):"function"==typeof define&&define.amd?define("angular-in-memory-web-api",["exports","rxjs","rxjs/operators","@angular/core","@angular/common","@angular/common/http"],t):t((e=e||self).angularInMemoryWebApi={},e.rxjs,e.rxjs.operators,e.ng.core,e.ng.common,e.ng.common.http)}(this,(function(e,t,r,o,s,i){"use strict";
/**
     * @license
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var p,d=function d(){},u=function u(){};function l(e){for(var t=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/.exec(e),r={source:"",protocol:"",authority:"",userInfo:"",user:"",password:"",host:"",port:"",relative:"",path:"",directory:"",file:"",query:"",anchor:""},o=Object.keys(r),s=o.length;s--;)r[o[s]]=t&&t[s]||"";return r}function f(e){return e.replace(/\/$/,"")}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(p=function p(e){void 0===e&&(e={}),Object.assign(this,{caseSensitiveSearch:!1,dataEncapsulation:!1,delay:500,delete404:!1,passThruUnknownUrl:!1,post204:!0,post409:!1,put204:!0,put404:!1,apiBase:void 0,host:void 0,rootPath:void 0},e)}).decorators=[{type:o.Injectable}],p.ctorParameters=function(){return[{type:u}]};var g=function(){function e(e,t){void 0===t&&(t={}),this.inMemDbService=e,this.config=new p,this.db={},this.requestInfoUtils=this.getRequestInfoUtils();var r=this.getLocation("/");this.config.host=r.host,this.config.rootPath=r.path,Object.assign(this.config,t)}return Object.defineProperty(e.prototype,"dbReady",{get:function(){return this.dbReadySubject||(this.dbReadySubject=new t.BehaviorSubject(!1),this.resetDb()),this.dbReadySubject.asObservable().pipe(r.first((function(e){return e})))},enumerable:!1,configurable:!0}),e.prototype.handleRequest=function(e){var t=this;return this.dbReady.pipe(r.concatMap((function(){return t.handleRequest_(e)})))},e.prototype.handleRequest_=function(e){var t,r=this,o=e.urlWithParams?e.urlWithParams:e.url,s=this.bind("parseRequestUrl"),i=s&&s(o,this.requestInfoUtils)||this.parseRequestUrl(o),c=i.collectionName,a=this.db[c],h={req:e,apiBase:i.apiBase,collection:a,collectionName:c,headers:this.createHeaders({"Content-Type":"application/json"}),id:this.parseId(a,c,i.id),method:this.getRequestMethod(e),query:i.query,resourceUrl:i.resourceUrl,url:o,utils:this.requestInfoUtils};if(/commands\/?$/i.test(h.apiBase))return this.commands(h);var p=this.bind(h.method);if(p){var d=p(h);if(d)return d}return this.db[c]?this.createResponse$((function(){return r.collectionHandler(h)})):this.config.passThruUnknownUrl?this.getPassThruBackend().handle(e):(t=this.createErrorResponseOptions(o,n.NOT_FOUND,"Collection '"+c+"' not found"),this.createResponse$((function(){return t})))},e.prototype.addDelay=function(e){var r=this.config.delay;return 0===r?e:function o(e,r){return new t.Observable((function(t){var o=!1,s=!1,i=e.subscribe((function(e){s=!0,setTimeout((function(){t.next(e),o&&t.complete()}),r)}),(function(e){return setTimeout((function(){return t.error(e)}),r)}),(function(){o=!0,s||t.complete()}));return function(){return i.unsubscribe()}}))}(e,r||500)},e.prototype.applyQuery=function(e,t){var r=[],o=this.config.caseSensitiveSearch?void 0:"i";t.forEach((function(e,t){e.forEach((function(e){return r.push({name:t,rx:new RegExp(decodeURI(e),o)})}))}));var s=r.length;return s?e.filter((function(e){for(var t=!0,o=s;t&&o;){var i=r[o-=1];t=i.rx.test(e[i.name])}return t})):e},e.prototype.bind=function(e){var t=this.inMemDbService[e];return t?t.bind(this.inMemDbService):void 0},e.prototype.bodify=function(e){return this.config.dataEncapsulation?{data:e}:e},e.prototype.clone=function(e){return JSON.parse(JSON.stringify(e))},e.prototype.collectionHandler=function(e){var t;switch(e.method){case"get":t=this.get(e);break;case"post":t=this.post(e);break;case"put":t=this.put(e);break;case"delete":t=this.delete(e);break;default:t=this.createErrorResponseOptions(e.url,n.METHOD_NOT_ALLOWED,"Method not allowed")}var r=this.bind("responseInterceptor");return r?r(t,e):t},e.prototype.commands=function(e){var t=this,o=e.collectionName.toLowerCase(),s=e.method,i={url:e.url};switch(o){case"resetdb":return i.status=n.NO_CONTENT,this.resetDb(e).pipe(r.concatMap((function(){return t.createResponse$((function(){return i}),!1)})));case"config":if("get"===s)i.status=n.OK,i.body=this.clone(this.config);else{var c=this.getJsonBody(e.req);Object.assign(this.config,c),this.passThruBackend=void 0,i.status=n.NO_CONTENT}break;default:i=this.createErrorResponseOptions(e.url,n.INTERNAL_SERVER_ERROR,'Unknown command "'+o+'"')}return this.createResponse$((function(){return i}),!1)},e.prototype.createErrorResponseOptions=function(e,t,r){return{body:{error:""+r},url:e,headers:this.createHeaders({"Content-Type":"application/json"}),status:t}},e.prototype.createResponse$=function(e,t){void 0===t&&(t=!0);var r=this.createResponseOptions$(e),o=this.createResponse$fromResponseOptions$(r);return t?this.addDelay(o):o},e.prototype.createResponseOptions$=function(e){var r=this;return new t.Observable((function(t){var o;try{o=e()}catch(e){o=r.createErrorResponseOptions("",n.INTERNAL_SERVER_ERROR,""+(e.message||e))}var s=o.status;try{o.statusText=null!=s?a(s):void 0}catch(e){}return null!=s&&h(s)?(t.next(o),t.complete()):t.error(o),function(){}}))},e.prototype.delete=function(e){var t=e.collection,r=e.headers,o=e.id;return null==o?this.createErrorResponseOptions(e.url,n.NOT_FOUND,'Missing "'+e.collectionName+'" id'):{headers:r,status:this.removeById(t,o)||!this.config.delete404?n.NO_CONTENT:n.NOT_FOUND}},e.prototype.findById=function(e,t){return e.find((function(e){return e.id===t}))},e.prototype.genId=function(e,t){var r=this.bind("genId");if(r){var o=r(e,t);if(null!=o)return o}return this.genIdDefault(e,t)},e.prototype.genIdDefault=function(e,t){if(!this.isCollectionIdNumeric(e,t))throw new Error("Collection '"+t+"' id type is non-numeric or unknown. Can only generate numeric ids.");var r=0;return e.reduce((function(e,t){r=Math.max(r,"number"==typeof t.id?t.id:r)}),void 0),r+1},e.prototype.get=function(e){var t=e.collection,r=e.collectionName,o=e.headers,s=e.id,i=e.query,c=e.url,a=t;return null!=s&&""!==s?a=this.findById(t,s):i&&(a=this.applyQuery(t,i)),a?{body:this.bodify(this.clone(a)),headers:o,status:n.OK}:this.createErrorResponseOptions(c,n.NOT_FOUND,"'"+r+"' with id='"+s+"' not found")},e.prototype.getLocation=function(e){if(!e.startsWith("http")){var t="undefined"==typeof document?void 0:document,r=t?t.location.protocol+"//"+t.location.host:"http://fake";e=e.startsWith("/")?r+e:r+"/"+e}return l(e)},e.prototype.getPassThruBackend=function(){return this.passThruBackend?this.passThruBackend:this.passThruBackend=this.createPassThruBackend()},e.prototype.getRequestInfoUtils=function(){var e=this;return{createResponse$:this.createResponse$.bind(this),findById:this.findById.bind(this),isCollectionIdNumeric:this.isCollectionIdNumeric.bind(this),getConfig:function(){return e.config},getDb:function(){return e.db},getJsonBody:this.getJsonBody.bind(this),getLocation:this.getLocation.bind(this),getPassThruBackend:this.getPassThruBackend.bind(this),parseRequestUrl:this.parseRequestUrl.bind(this)}},e.prototype.indexOf=function(e,t){return e.findIndex((function(e){return e.id===t}))},e.prototype.parseId=function(e,t,r){if(!this.isCollectionIdNumeric(e,t))return r;var o=parseFloat(r);return isNaN(o)?r:o},e.prototype.isCollectionIdNumeric=function(e,t){return!(!e||!e[0])&&"number"==typeof e[0].id},e.prototype.parseRequestUrl=function(e){try{var t=this.getLocation(e),r=(this.config.rootPath||"").length,o="";t.host!==this.config.host&&(r=1,o=t.protocol+"//"+t.host+"/");var s=t.path.substring(r).split("/"),i=0,n=void 0;null==this.config.apiBase?n=s[i++]:i=(n=f(this.config.apiBase.trim()))?n.split("/").length:0;var c=s[i++];return{apiBase:n+="/",collectionName:c=c&&c.split(".")[0],id:s[i++],query:this.createQueryMap(t.query),resourceUrl:o+n+c+"/"}}catch(t){throw new Error("unable to parse url '"+e+"'; original error: "+t.message)}},e.prototype.post=function(e){var t=e.collection,r=e.collectionName,o=e.headers,s=e.id,i=e.resourceUrl,c=e.url,a=this.clone(this.getJsonBody(e.req));if(null==a.id)try{a.id=s||this.genId(t,r)}catch(e){var h=e.message||"";return/id type is non-numeric/.test(h)?this.createErrorResponseOptions(c,n.UNPROCESSABLE_ENTRY,h):this.createErrorResponseOptions(c,n.INTERNAL_SERVER_ERROR,"Failed to generate new id for '"+r+"'")}if(s&&s!==a.id)return this.createErrorResponseOptions(c,n.BAD_REQUEST,"Request id does not match item.id");var p=this.indexOf(t,s=a.id),d=this.bodify(a);return-1===p?(t.push(a),o.set("Location",i+"/"+s),{headers:o,body:d,status:n.CREATED}):this.config.post409?this.createErrorResponseOptions(c,n.CONFLICT,"'"+r+"' item with id='"+s+" exists and may not be updated with POST; use PUT instead."):(t[p]=a,this.config.post204?{headers:o,status:n.NO_CONTENT}:{headers:o,body:d,status:n.OK})},e.prototype.put=function(e){var t=e.collection,r=e.collectionName,o=e.headers,s=e.id,i=e.url,c=this.clone(this.getJsonBody(e.req));if(null==c.id)return this.createErrorResponseOptions(i,n.NOT_FOUND,"Missing '"+r+"' id");if(s&&s!==c.id)return this.createErrorResponseOptions(i,n.BAD_REQUEST,"Request for '"+r+"' id does not match item.id");var a=this.indexOf(t,s=c.id),h=this.bodify(c);return a>-1?(t[a]=c,this.config.put204?{headers:o,status:n.NO_CONTENT}:{headers:o,body:h,status:n.OK}):this.config.put404?this.createErrorResponseOptions(i,n.NOT_FOUND,"'"+r+"' item with id='"+s+" not found and may not be created with PUT; use POST instead."):(t.push(c),{headers:o,body:h,status:n.CREATED})},e.prototype.removeById=function(e,t){var r=this.indexOf(e,t);return r>-1&&(e.splice(r,1),!0)},e.prototype.resetDb=function(e){var o=this;this.dbReadySubject&&this.dbReadySubject.next(!1);var s=this.inMemDbService.createDb(e);return(s instanceof t.Observable?s:"function"==typeof s.then?t.from(s):t.of(s)).pipe(r.first()).subscribe((function(e){o.db=e,o.dbReadySubject&&o.dbReadySubject.next(!0)})),this.dbReady},e}(),R=function(e,t){return(R=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])})(e,t)},m=function(e){function t(t,r,o){var s=e.call(this,t,r)||this;return s.xhrFactory=o,s}return function o(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");function r(){this.constructor=e}R(e,t),e.prototype=null===t?Object.create(t):(r.prototype=t.prototype,new r)}(t,e),t.prototype.handle=function(e){try{return this.handleRequest(e)}catch(r){var t=this.createErrorResponseOptions(e.url,n.INTERNAL_SERVER_ERROR,""+(r.message||r));return this.createResponse$((function(){return t}))}},t.prototype.getJsonBody=function(e){return e.body},t.prototype.getRequestMethod=function(e){return(e.method||"get").toLowerCase()},t.prototype.createHeaders=function(e){return new i.HttpHeaders(e)},t.prototype.createQueryMap=function(e){var t=new Map;if(e){var r=new i.HttpParams({fromString:e});r.keys().forEach((function(e){return t.set(e,r.getAll(e)||[])}))}return t},t.prototype.createResponse$fromResponseOptions$=function(e){return e.pipe(r.map((function(e){return new i.HttpResponse(e)})))},t.prototype.createPassThruBackend=function(){try{return new i.HttpXhrBackend(this.xhrFactory)}catch(e){throw e.message="Cannot create passThru404 backend; "+(e.message||""),e}},t}(g);
/*! *****************************************************************************
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function _(e,t,r){return new m(e,t,r)}m.decorators=[{type:o.Injectable}],m.ctorParameters=function(){return[{type:d},{type:u,decorators:[{type:o.Inject,args:[p]},{type:o.Optional}]},{type:s.XhrFactory}]};var y=function(){function e(){}return e.forRoot=function(t,r){return{ngModule:e,providers:[{provide:d,useClass:t},{provide:p,useValue:r},{provide:i.HttpBackend,useFactory:_,deps:[d,p,s.XhrFactory]}]}},e.forFeature=function(t,r){return e.forRoot(t,r)},e}();y.decorators=[{type:o.NgModule}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var T=function(){function e(){}return e.forRoot=function(t,r){return{ngModule:e,providers:[{provide:d,useClass:t},{provide:p,useValue:r},{provide:i.HttpBackend,useFactory:_,deps:[d,p,s.XhrFactory]}]}},e.forFeature=function(t,r){return e.forRoot(t,r)},e}();T.decorators=[{type:o.NgModule}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BackendService=g,e.HttpClientBackendService=m,e.HttpClientInMemoryWebApiModule=y,e.InMemoryBackendConfig=p,e.InMemoryBackendConfigArgs=u,e.InMemoryDbService=d,e.InMemoryWebApiModule=T,e.STATUS=n,e.STATUS_CODE_INFO=c,e.getStatusText=a,e.httpClientInMemBackendServiceFactory=_,e.isSuccess=h,e.parseUri=l,e.removeTrailingSlash=f,Object.defineProperty(e,"__esModule",{value:!0})}));